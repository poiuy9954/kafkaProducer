...
public class SimpleCallBackProducer {
    private static final Logger log = LoggerFactory.getLogger(SimpleCallBackProducer.class);
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        ProducerRecord<String, String> record = new ProducerRecord<>(TOPIC_NAME,"23"); //Kafka record 전송및 생성 인스턴스
        producer.send(record,new ProducerCallback()); //실제 전송하진않고 배치에 포함되게 하는것인
        log.info("{}", record);
